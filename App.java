public class App {
    public static void main(String[] args) {
        ...
        archer.sayMyIntelligence();
          ...
          Sword.damage = 100;
          Sword.name = "Bhea's Sword";
          Sword.weight = 5.5f;
          Sword.rarity = "Common";
          Sword.hasElementalDamage = false;
          Sword.description = "A cheap sword  owned by Bhea";
  
          // Gear Class
          Gear Helmet = new Gear();

          Helmet.name = "Bhea's Helmet";
          Helmet.defence = 85;
          Helmet.weight = 8.1f;
          Helmet.description = "Limited Edition Helmet";
          Helmet.rarity = "Rare";
          Helmet.hasElementalDamage = true;
